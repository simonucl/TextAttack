...
class ICLTextAttackWord(AttackRecipe):
    ...
    def build(model_wrapper):
        ...
        # )
        # fmt: on
        constraints = [RepeatModification(), StopwordModification(stopwords=stopwords), MaxWordsPerturbed(max_percent=0.1), InstructionModification(columns_allowed=["Hypothesis_"])]
        #
