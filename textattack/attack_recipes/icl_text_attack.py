...
class ICLTextAttack(AttackRecipe):
    ...
    def build(model_wrapper):
        ...
        constraints = [RepeatModification(), StopwordModification(), InstructionModification(columns_allowed=["Hypothesis_", "Example_"]), MaxWordsPerturbed(max_percent=0.1)]
